            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <div className="flex flex-col space-y-4">
                  <a href="https://wa.me/821087764677?text=Chat%20on%20WhatsApp%20with%20%2B82%2010-8776-4677" className="flex items-center text-white hover:text-yellow-500 transition-colors">
                  ...
                  <a href="https://example.com/wechat?text=Chat%20on%20WeChat%20with%20%2B82%2010-8776-4677" className="flex items-center text-white hover:text-yellow-500 transition-colors">
                    <svg className="w-6 h-6 mr-3" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <a href="https://t.me/821087764677?text=Chat%20on%20Telegram%20with%20%2B82%2010-8776-4677" className="flex items-center text-white hover:text-yellow-500 transition-colors">
                    <svg className="w-6 h-6 mr-3" viewBox="0 0 24 24" fill="currentColor">
