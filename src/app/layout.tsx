        ...
        <main className="relative">
          ...
          <div className="fixed right-0 top-1/3 z-50 flex flex-col gap-1 bg-[#e8f5e9] rounded-l-lg shadow-lg md:translate-x-[70%] md:hover:translate-x-0 transition-transform duration-300">
            ...
            <a
              ...
              className="flex items-center p-2 hover:bg-[#e8f5e9] hover:text-[#25D366] transition-colors group"
            >
              <svg className="w-5 h-5 text-[#25D366] group-hover:text-[#25D366]" viewBox="0 0 24 24" fill="currentColor">
              ...
              <span className="ml-2 text-xs hidden md:block">+821087764677</span>
            </a>

            {/* WeChat */}
            <button
              onClick={() => setShowQR(!showQR)}
              className="flex items-center p-2 hover:bg-[#e8f5e9] hover:text-[#07C160] transition-colors group"
            >
              <svg className="w-5 h-5 text-[#07C160] group-hover:text-[#07C160]" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a
              ...
              className="flex items-center p-2 hover:bg-[#e8f5e9] hover:text-[#0088cc] transition-colors group"
            >
              <svg className="w-5 h-5 text-[#0088cc] group-hover:text-[#0088cc]" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a
              ...
              className="flex items-center p-2 hover:bg-[#e8f5e9] hover:text-blue-500 transition-colors group"
            >
              <svg className="w-5 h-5 text-blue-500 group-hover:text-blue-500" viewBox="0 0 24 24" fill="currentColor">
                <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
              </svg>
              <span className="ml-2 text-xs hidden md:block">dabinko@kita.net</span>
            </a>
          </div>
