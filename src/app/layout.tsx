        ...
        <main className="relative">
          ...
          <div className="bg-white py-12">
            <div className="max-w-6xl mx-auto px-4">
              <img src="/images/logo.png" alt="Dabinko Logo" className="h-24 mx-auto mb-8" />
            </div>
          </div>
          ...
          <section className="py-16 bg-gray-50">
            <div className="max-w-6xl mx-auto px-4">
              <h2 className="text-3xl font-bold text-center mb-12 border-b-4 border-yellow-500 pb-4 inline-block">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div className="space-y-6">
                  <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="p-4">
                      <h3 className="font-bold text-lg mb-2">Raw Material</h3>
                    </div>
                  </div>
                  <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                    <img src="/images/procedure2.jpg" alt="Mixing Process" className="w-full h-48 object-cover" />
                    <div className="p-4">
                      <h3 className="font-bold text-lg mb-2">Mixing Process</h3>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="p-4">
                      <h3 className="font-bold text-lg mb-2">Extruding</h3>
                    </div>
                  </div>
                  <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                    <img src="/images/procedure4.jpg" alt="Splicing" className="w-full h-48 object-cover" />
                    <div className="p-4">
                      <h3 className="font-bold text-lg mb-2">Splicing</h3>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="p-4">
                      <h3 className="font-bold text-lg mb-2">Vulcanizing</h3>
                    </div>
                  </div>
                  <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="fixed right-0 top-1/3 z-50 flex flex-col gap-1 bg-[#4CAF50] bg-opacity-20 rounded-l-lg shadow-lg transform transition-all duration-300 hover:scale-110">
            {/* WhatsApp */}
            <a
              href="https://wa.me/821087764677"
              className="flex items-center p-2 hover:bg-[#4CAF50] hover:text-white transition-colors group"
            >
              <svg className="w-5 h-5 text-[#25D366] group-hover:text-white" viewBox="0 0 24 24" fill="currentColor">
              ...
              <span className="ml-2 text-xs group-hover:text-white">+821087764677</span>
            </a>

            {/* WeChat */}
            <button
              onClick={() => setShowQR(!showQR)}
              className="flex items-center p-2 hover:bg-[#4CAF50] hover:text-white transition-colors group w-full text-left"
            >
              <svg className="w-5 h-5 text-[#07C160] group-hover:text-white" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a
              ...
              className="flex items-center p-2 hover:bg-[#4CAF50] hover:text-white transition-colors group"
            >
              <svg className="w-5 h-5 text-[#0088cc] group-hover:text-white" viewBox="0 0 24 24" fill="currentColor">
            ...
            >
              ...
              <span className="ml-2 text-xs group-hover:text-white">dabinko@kita.net</span>
            </a>
          </div>
