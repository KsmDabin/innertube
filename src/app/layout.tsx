            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <div className="flex flex-col space-y-4">
                  <a href="https://wa.me/821087764677" className="flex items-center text-white hover:text-yellow-500 transition-colors">
                  ...
                  <a href="#" className="flex items-center text-white hover:text-yellow-500 transition-colors">
                    <svg className="w-6 h-6 mr-3" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <a href="https://t.me/821087764677" className="flex items-center text-white hover:text-yellow-500 transition-colors">
                    <svg className="w-6 h-6 mr-3" viewBox="0 0 24 24" fill="currentColor">
