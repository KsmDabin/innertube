      ...
      <body className={inter.className}>
        ...
        <div className="fixed right-0 top-1/3 z-50 flex flex-col gap-2 bg-white rounded-l-lg shadow-lg">
          ...
          <a
            ...
            className="flex items-center p-3 hover:bg-[#25D366] hover:text-white transition-colors group"
          >
            <svg className="w-6 h-6 text-[#25D366] group-hover:text-white" viewBox="0 0 24 24" fill="currentColor">
            ...
            <span className="ml-2 text-sm">+821087764677</span>
          </a>

          {/* WeChat */}
          <button
            onClick={() => setShowQR(!showQR)}
            className="flex items-center p-3 hover:bg-[#07C160] hover:text-white transition-colors group"
          >
            <svg className="w-6 h-6 text-[#07C160] group-hover:text-white" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a
            ...
            className="flex items-center p-3 hover:bg-[#0088cc] hover:text-white transition-colors group"
          >
            <svg className="w-6 h-6 text-[#0088cc] group-hover:text-white" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a
            ...
            className="flex items-center p-3 hover:bg-blue-500 hover:text-white transition-colors group"
          >
            <svg className="w-6 h-6 text-blue-500 group-hover:text-white" viewBox="0 0 24 24" fill="currentColor">
              <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
              <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
            </svg>
            <span className="ml-2 text-sm">dabinko@kita.net</span>
          </a>
        </div>
